      ...
      <div className="section-container">
        ...
        <header className="mb-16">
          <nav className="flex items-center gap-2 text-xs text-text-muted mb-6">
            ...
            <ChevronRight size={12} />
            <span className="text-brand-primary font-bold">Teachers</span>
          </nav>
          
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            <div className="max-w-2xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-text-main leading-none mb-6">
                Our Expert <span className="text-brand-primary">Faculty</span>
              </h1>
              <p className="text-lg text-text-muted text-justify leading-relaxed">
                Meet the dedicated educators of Demo Model College. Our faculty members combine deep academic expertise with a passion for mentoring students to reach their highest potential.
              </p>
            </div>
          </div>
        </header>
        ...
        <div className="mb-8 flex items-center justify-between">
          <p className="text-sm font-bold text-text-muted">
            Showing <span className="text-brand-primary">{filteredTeachers.length}</span> faculty members
          </p>
          {searchTerm && (
            <button 
        ...
        {filteredTeachers.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl border border-ui-border p-20 text-center">
            ...
            <h3 className="text-2xl font-black text-text-main mb-2">No teachers found</h3>
