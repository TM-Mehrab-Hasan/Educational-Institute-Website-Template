          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-slate-50 rounded-[2.5rem] p-12 border border-ui-border relative overflow-hidden group">
              ...
              <p className="text-text-muted text-justify italic leading-relaxed relative z-10">
                "As an educator at Demo Model College, my goal is to not only impart knowledge but to inspire curiosity and critical thinking. I believe in creating an inclusive environment where every student feels empowered to explore their potential and prepare for the challenges of tomorrow."
              </p>
            </div>
          </div>
        </div>
