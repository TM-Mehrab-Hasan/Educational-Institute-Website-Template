...
export default function GuardianRegisterForm({ onLoginClick, onSuccess }: GuardianRegisterFormProps) {
  const { register } = useGuardianAuth();
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-ui-border overflow-hidden">
        <div className="p-8 md:p-10">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-black text-text-main uppercase tracking-tight mb-2">Guardian Registration</h2>
            <p className="text-sm text-text-muted font-medium">Create parent account to manage student info</p>
          </div>
